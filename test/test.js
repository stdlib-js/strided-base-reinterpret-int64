...
tape( 'the function reinterprets a 64-bit signed integer array', function test( t ) {
	var values;
	var v;
	var i;
...
tape( 'the function reinterprets a 64-bit signed integer array (byte offset)', function test( t ) {
	var values;
	var buf;
	var v;
	var i;
	...
	values = [
		new Int64Array( buf, 320, 10 ),
		new Int64Array( buf, 32, 5 ),
		new Int64Array( buf, 112, 20 )
	];
...
tape( 'the function reinterprets a 64-bit signed integer array (index offset)', function test( t ) {
	var values;
	var v;
	var i;
