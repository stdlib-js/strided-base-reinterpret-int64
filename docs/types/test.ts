...
import Int64Array = require( '@stdlib/array-int64' );
...
{
	reinterpret( new Int64Array( 10 ), 0 ); // $ExpectType Uint32Array
}

// The compiler throws an error if not provided a first argument which is a Int64Array...
{
